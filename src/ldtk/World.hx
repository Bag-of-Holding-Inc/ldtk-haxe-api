...
class World {
	...
	public var untypedLevels : Array<ldtk.Level>;
	...
	@:keep public function toString() {
		return 'ldtk.World[$identifier, $layout, ${untypedLevels.length} levels]';
	}
	...
	function fromJson(untypedJson:Dynamic) {
		...
		for(json in json.levels)
			untypedLevels.push( _instanciateLevel(untypedProject, idx++, json) );
	}


	function _instanciateLevel(project:ldtk.Project, arrayIndex:Int, json:ldtk.Json.LevelJson) {
		return new Level(project, arrayIndex, json);
	}
